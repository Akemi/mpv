...
enum {
    ...
    MAC_CSP_LINEAR_DISPLAY_P3,
    MAC_CSP_DCIP3,
    MAC_CSP_ITUR_2020,
    MAC_CSP_LINEAR_ITUR_2020,
    MAC_CSP_ITUR_2100_HLG,
    MAC_CSP_ITUR_2100_PQ,
    MAC_CSP_ITUR_709,
    MAC_CSP_ITUR_709_HLG,
    MAC_CSP_ITUR_709_PQ,
    MAC_CSP_SRGB,
    MAC_CSP_LINEAR_SRGB,
    MAC_CSP_GENERIC_RGB_LINEAR,
    MAC_CSP_ADOBE_RGB1998,
};
