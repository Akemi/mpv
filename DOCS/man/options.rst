...
``--cocoa-cb-output-csp=<csp>``
    ...
    :linear_display_p3:  DCI P3 primaries, a D65 white point and linear transfer function.
    :dcip3:              DCI P3 color space.
    :itur_2020:          ITU BT.2020 color space.
    :linear_itur_2020:   ITU BT.2020 color space and linear transfer function.
    :itur_2100_hlg:      ITU BT.2100 and the Hybrid Log-Gamma (HLG) transfer function.
    :itur_2100_pq:       ITU BT.2100 and the Perceptual Quantizer (PQ) transfer function.
    :itur_709:           ITU BT.709 color space.
    :itur_709_hlg:       ITU BT.709 and the Hybrid Log-Gamma (HLG) transfer function.
    :itur_709_pq:        ITU BT.709 and the Perceptual Quantizer (PQ) transfer function.
